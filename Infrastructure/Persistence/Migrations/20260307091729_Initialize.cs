    ...
    public partial class Initialize : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:order_status", "pending,confirmed,processing,shipping,completed,cancelled,refunded")
                .Annotation("Npgsql:Enum:payment_method", "cod,bank_transfer,vnpay,momo,stripe,paypal,other")
                .Annotation("Npgsql:Enum:payment_status", "unpaid,paid,failed,refunded,partially_refunded")
                .Annotation("Npgsql:Enum:shipment_status", "pending,ready,shipped,delivered,returned,cancelled");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ship_recipient = table.Column<string>(type: "text", nullable: false),
                    ship_phone = table.Column<string>(type: "text", nullable: false),
                    ship_line1 = table.Column<string>(type: "text", nullable: false),
                    ship_line2 = table.Column<string>(type: "text", nullable: true),
                    ship_ward = table.Column<string>(type: "text", nullable: true),
                    ship_district = table.Column<string>(type: "text", nullable: true),
                    ship_province = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    compare_at = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_cart_items", x => new { x.cart_id, x.variant_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_inventory", x => new { x.warehouse_id, x.variant_id });
                    table.ForeignKey(
