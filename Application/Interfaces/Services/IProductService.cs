...
{
    Task<Result<(List<ProductDto> Items, long Total)>> GetPagedAsync(int page, int pageSize, string? search, int? status, List<Guid> categoryId, CancellationToken cancellationToken = default);
