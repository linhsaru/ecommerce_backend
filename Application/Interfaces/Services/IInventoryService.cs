...
{
    Task<Result<(List<InventoryDto> Items, long Total)>> GetPagedAsync(int page, int pageSize, Guid? warehouseId, Guid? variantId, CancellationToken cancellationToken = default);
